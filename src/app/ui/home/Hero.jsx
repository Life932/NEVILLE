  ...
  return (
    <section className="relative flex min-h-[560px] w-full flex-col overflow-hidden bg-background text-foreground md:min-h-[calc(100vh-4.5rem)] transition-colors duration-300">
      ...
      <motion.div
        ...
        className="z-20 mt-auto h-10 w-full min-h-10 rounded-t-2xl bg-muted/70 border-t border-border shadow-neo-sm md:h-[16vh] md:min-h-16 md:rounded-t-[2.5rem] lg:rounded-t-[3rem]"
      >
