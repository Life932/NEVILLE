...
- *Rule:* Always use the CLI to add Shadcn components rather than building them from scratch.
...
1. **Context7 (`context7`):** USE THIS to read the official documentation for Next.js, Shadcn UI, and Aceternity UI *before* generating complex components.
